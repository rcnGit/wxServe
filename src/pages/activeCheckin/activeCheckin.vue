    ...
    methods:{
        getData:function(){
            ...
            .then(function(res) {//成功之后
                ...
                window.location.href='https://open.weixin.qq.com/connect/oauth2/authorize?appid='+that.APPID+'&redirect_uri='+serbackUrl+'&response_type=code&scope=snsapi_userinfo&state=activeCheckin_'+that.param.actId+'#wechat_redirect';
                }else{
