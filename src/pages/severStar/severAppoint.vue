     ...
     <div >
        ...
        <div class='content'>
            <div class='term'>
                ...
                <p class="term_top">财富师{{busNameT}}感谢您的点亮</p>
            </div>
            <div class='inpdiv'>
                <img src='./img/phone.png' class='inpIcon' />
                <input type='tel' class='inpTel' maxlength='11' v-model="param.phone" ref='phone2' placeholder="请输入手机号" />
             ...
             <mt-button type="danger" size="large" class='sign' @click="toAppoint()" :disabled="isdisabled">为TA点亮</mt-button>
        </div>
        <div style="width:10rem;height:.266667rem;background:#f9f9f9;"></div>
        <div class="getWill">
            <div class="get-top">
                <span class="redline"></span>
                <p class="get-toptxt">您将获得</p>
            </div>
            <div style="height: 1px;background:#f6f6f6;width:9.733333rem;margin-left: .266667rem; "></div>
            <ul class="get_ul">
                <li>
        ...
        <div class='xieyi' v-show='showFrom'>
			<div class='box'>
			<p><img src='./img/close@2x.png' class='closexieyi' @click="closeXieyi"/></p>
			<div class="clearfix"></div>
			<div class="title">用户注册协议</div>
			<p>大唐财富APP、大唐财富服务号（以下称“唐鼎耀华旗下平台”）是北京唐鼎耀华基金销售有限公司(以下称“唐鼎耀华”)旗下的投资平台。用户在注册时，可根据自身需求选择唐鼎耀华旗下任一平台进行注册（以下称“注册平台”）。在注册平台进行注册前请认真阅读、充分理解本协议所有条款，一经注册即视为对本协议全部条款已充分理解并完全接受，依据本协议成为唐鼎耀华的用户（以下简称“用户”）并使本协议立即产生法律效力。</p>
			<p class="bigP">第一章 协议的签署和修订</p>
			<p>第一条 注册用户应是年满18周岁，具有完全的民事权利能力和民事行为能力的自然人，且为满足外部监管要求的合规投资者。</p>
			<p>第二条 本协议内容包括协议全部条款及注册平台已经发布的或将来可能发布的与用户有关的各类规则，所有规则均为本协议不可分割的一部分，与本协议具有同等法律效力。</p>
			<p>第三条 本协议用户一经注册即视为充分理解并全部接受本协议的全部内容，并使本协议立即产生法律效力。为避免歧义，用户不得以未签署书面协议为由否认本协议的效力。</p>
			<p>第四条 注册用户必须承诺遵守中国的各项法律规定，任何违反法律规定的行为导致的一切法律后果，由用户个人以自己的名义独立承担所有相应的法律责任。</p>
			<p>第五条 唐鼎耀华有权根据需要修改本协议或根据本协议制定、修改各类具体规则。如有任何变更，唐鼎耀华将发布公告，无需另行单独通知用户。用户在本协议及具体规则内容公告变更后继续使用本服务的，视为用户已充分阅读、理解并接受修改后的协议和具体规则内容，并接受修改后的协议和具体规则的约束。若用户不同意修改后的协议内容，应自行停止使用注册平台的服务。</p>
			<p>第六条 唐鼎耀华可向其关联方转让本协议项下的全部或部分权利和义务；未经唐鼎耀华同意，用户不得转让其在本协议项下的任何权利和义务。</p>
			<p>第七条 本协议不涉及用户与用户之间的法律关系与纠纷。</p>
			<p class="bigP">第二章 服务的提供</p>
			<p>第八条 用户使用唐鼎耀华的服务应直接登录大唐财富APP或大唐财富服务号，请勿通过邮件或其他网站提供的链接登录。用户拨打唐鼎耀华客服电话应以唐鼎耀华网站公布的客服电话号码为准，请勿拨打其他电话。</p>
			<p>第九条 经注册成为注册平台的用户后，将生成用户的个人账户，该账户将记录用户在注册平台的所有活动，该账户是用户登录注册平台的唯一账户，用户通过账户进行的一切行为均视作用户本人真实、自愿的行为。用户应妥善保管自己的账号及密码等账户信息，用户不得以账户信息被盗或其他理由否认行为的效力或不履行相关义务。</p>
			<p>第十条 唐鼎耀华将向符合条件的用户提供服务：（1）服务包括但不限于：投资交易信息发布、提供投资交易管理服务、提供客服服务，具体详情以注册平台届时提供的服务内容为准；（2）唐鼎耀华提供的各种投资信息及资料仅为参考，用户应独立判断、自行决策，用户进行的交易所产生的风险由用户自行承担，唐鼎耀华不承担任何的法律责任；（3）唐鼎耀华对用户在注册平台上进行的投资交易行为不承担任何责任，唐鼎耀华无法也没有义务保证用户能够实际投资成功，用户因前述原因导致的损失（包括但不限于投资收益、手续费、投资本金等）由用户自行承担，唐鼎耀华不承担任何责任；（4）因用户自身的原因导致注册平台无法提供服务或提供服务时发生任何错误而产生的任何损失或责任，由用户自行负责，唐鼎耀华不承担任何责任。</p>
			<p>第十一条 基于运行和交易安全的需要，唐鼎耀华可以暂时停止提供、限制或改注册平台服务的部分功能，或提供新的功能。在任何功能减少、增加或者变化时，用户继续使用注册平台服务的行为，视为用户同意本协议或者变更后的协议。</p>
			<p>第十二条 用户在注册平台上按服务流程所确认的交易状态将成为用户本人进行相关交易或操作（包括但不限于支取款项、冻结资金、订立合同等）不可撤销的指令。注册平台有权按相关指令依据本协议和有关规则对相关事项进行处理。</p>
			<p class="bigP">第三章 交易管理及费用</p>
			<p>第十三条 经成功注册后，用户可根据注册平台上有关规则和说明确认签署有关协议，并经审核通过后实现投资交易。详细操作规则及方式请见有关协议及注册平台相关页面的规则和说明。</p>
			<p>第十四条 唐鼎耀华将为用户的投资交易提供平台中介服务，并在服务过程中根据本协议或注册平台页面的相关规则、说明等收取必要的服务费或手续费，其具体内容、比例、金额等事项请参见相关协议及注册平台相关页面的规则和说明。唐鼎耀华有权调整前述服务费或手续费的类型或金额等具体事项并根据本协议和相关规则进行公告、修改。</p>
			<p class="bigP">第四章 资金管理</p>
			<p>第十五条 就用户在注册平台进行的投资交易，由唐鼎耀华合作的第三方机构提供“资金管理服务”，包括但不限于：银行卡认证、资金的充值、提现、代收、代付、查询等，具体详情以唐鼎耀华及第三方机构当时提供的服务内容为准。</p>
			<p>第十六条 上述充值、提现、代收、代付以及查询等服务涉及唐鼎耀华与第三方支付机构或金融机构的合作，因此：（1）受第三方机构进行资金代扣及划转行为的限制，唐鼎耀华不对前述服务的资金到账时间做任何承诺，也不承担与此相关的责任，包括但不限于由此产生的利息、货币贬值等损失；（2）一经用户使用前述服务，即表示用户不可撤销地授权唐鼎耀华或第三方机构进行相关操作，且该等操作是不可逆转的，用户不能以任何理由拒绝付款或要求取消交易；（3）用户在使用注册平台服务过程中可能需要向第三方机构支付一定的费用，具体收费标准详见第三方机构网站相关页面，或注册平台的提示；（4）在任何情况下，涉及由第三方机构提供相关服务的责任由该第三方机构承担，唐鼎耀华不承担任何责任。</p>
			<p>第十七条 用户承诺资金来源合法，唐鼎耀华及第三方机构有权按照包括但不限于司法机关、行政机关等的要求协助对用户账户及资金等进行查询、冻结或扣划等操作。</p>
			<p>第十八条 唐鼎耀华通过注册平台有权基于交易安全等方面的考虑设定涉及交易的相关事项，包括但不限于交易限额、交易次数等，具体详情以注册平台当时提供的服务内容为准。</p>
			...
			<p>第二十条 在注册平台进行交易而订立电子合同形式的协议，可以为一份或多份形式并且每一份具有同等法律效力。用户根据本协议及注册平台上的相关规则在注册平台确认签署的电子合同即视为用户本人自愿签署的合同，具有法律效力。</p>
			<p>第二十一条 用户根据本协议以及注册平台的相关规则签署电子合同后，不得擅自修改该合同。注册平台为用户提供相关电子合同的保管、查询、核对等服务，如对电子合同真伪或电子合同的内容有疑问，用户可通过注册平台查阅有关合同并进行核对。如对相关合同内容有任何争议，应以注册平台记录的合同为准。</p>
			<p class="bigP">第六章 用户信息及隐私权保护</p>
			<p>第二十二条 用户在注册时应提供真实、完整、有效的资料，并保证资料的安全性和及时更新。唐鼎耀华根据用户提供的资料无法与用户取得及时、有效的联系而导致用户在使用注册平台服务的过程中遭受任何损失或增加任何费用等不利后果均由用户自行完全承担。</p>
			<p>第二十三条 唐鼎耀华可使用自公开及私人资料来源收集用户的额外资料，以更好地了解用户，并为其度身订造大唐财富的服务、解决争议和确保在注册平台进行交易的安全性。唐鼎耀华仅收集唐鼎耀华认为就此目的及达成该目的所必须的关于用户的个人资料。</p>
			<p>第二十四条 唐鼎耀华可以自行或通过合作的第三方机构对用户提交或唐鼎耀华搜集的用户信息（包括但不限于用户的个人身份证信息等）进行核实，并对获得的核实结果根据本协议及有关文件进行查看、使用和留存等操作。</p>
			<p>第二十五条 唐鼎耀华可以按照用户在注册平台上的行为自动追踪用户的其他资料。唐鼎耀华可以利用前述资料进行有关注册平台用户的人口统计、兴趣及行为的内部研究，以更好地了解用户和向用户提供更好的服务。在不透露用户隐私的前提下，唐鼎耀华可以对整个用户数据库进行分析并对用户数据库进行商业上的利用。</p>
			<p>第二十六条 唐鼎耀华在唐鼎耀华旗下平台或网站的某些网页上使用诸如“Cookies”的资料收集装置，以协助唐鼎耀华为客户提供度身订造的服务。唐鼎耀华提供的某些服务只能通过使用“Cookies”实现。</p>
			<p>第二十七条 唐鼎耀华可使用关于用户的个人资料（包括但不限于唐鼎耀华旗下平台持有的用户档案中的资料，及唐鼎耀华从用户在唐鼎耀华旗下平台上的活动所获取的其他资料）以解决争议、对纠纷进行调停、确保在唐鼎耀华旗下平台进行安全交易，并执行服务协议及相关规则。</p>
			<p>第二十八条 为限制在唐鼎耀华旗下平台的欺诈、非法或其他刑事犯罪活动，唐鼎耀华可通过人工或自动程序对用户资料进行评价。</p>
			<p>第二十九条 唐鼎耀华可以使用用户资料以改进推广和促销工作、改善唐鼎耀华的内容和产品推广形式，并使唐鼎耀华旗下平台的内容、设计和服务更能符合用户的要求。唐鼎耀华可以利用用户资料与用户联络并传递用户可能感兴趣的信息。</p>
			...
			<p>第三十二条 任何通过唐鼎耀华旗下平台进行的交易不能避免以下风险的产生，唐鼎耀华无法也没有义务对此承担责任：（1）宏观经济风险：因宏观经济形势变化，可能引起价格等方面的异常波动，用户有可能遭受损失；（2）政策风险：有关法律、法规及相关政策、规则发生变化，可能引起价格等方面异常波动，用户有可能遭受损失；（3）违约风险：因其他交易方无力或无意愿按时足额履约，用户有可能遭受损失；（4）利率风险：市场利率变化可能对购买或持有产品的实际收益产生影响；（5）唐鼎耀华或者涉及的第三方网站的设备系统存在缺陷、遭到黑客攻击、网络故障、电力中断、计算机病毒以及其他不可抗力因素导致的风险；（6）因用户的过错导致的任何损失，该过错包括但不限于：决策失误、操作不当、遗忘或泄露密码、密码被他人破解、用户使用的计算机、手机等其它系统被第三方侵入、用户委托他人代理交易时他人恶意或不当操作而造成的损失。</p>
			<p>第三十三条 唐鼎耀华对用户发布的信息仅进行形式审核，不对用户发布的信息内容的真实性、充分性、及时性、可靠性、完整性和有效性，免除任何由此引起的法律责任。唐鼎耀华及其股东、创建人、高级职员、代理人、关联公司、母公司、子公司和工作人员不对任何用户或任何交易提供任何担保或条件，不以任何明示、默示或其他法定方式对用户使用唐鼎耀华旗下平台服务而产生的任何形式的直接或间接损失承担法律责任，包括但不限于资金损失、利润损失、营业中断损失等。</p>
			<p>第三十四条 唐鼎耀华无法也没有义务保证第三方网站上的信息的真实性和有效性。用户应按照第三方网站的服务协议使用第三方网站。第三方网站的内容、产品、广告和其他任何信息均由用户自行判断并承担风险。</p>
			<p>第三十五条 以上条款并不能揭示用户通过唐鼎耀华旗下平台进行交易的全部风险及市场的全部情形。用户在做出交易决策前，应全面了解相关交易，谨慎决策，并自行承担全部风险。</p>
			<p class="bigP">第八章 使用限制</p>
			<p>第三十六条 用户应合法使用注册平台提供的服务及平台上的内容，不得在注册平台从事任何可能违反中国的法律、法规、规章和政府规范性文件的行为或者任何未经授权的行为，不得利用注册平台的服务从事侵害他人合法权益的行为。</p>
			<p>第三十七条 唐鼎耀华有权根据法律、法规、政府要求透露、修改或者删除必要的信息，以便更好地运营注册平台并保护自身及注册平台其他合法用户的合法权益。</p>
			<p>第三十八条 唐鼎耀华旗下平台上的全部内容的版权均属于唐鼎耀华所有，包括但不限于文本、数据、文章、设计及其他全部信息。未经唐鼎耀华事先书面同意，用户不得以任何方式、任何形式复制、模仿、传播、公布、展示平台内容。</p>
			<p>第三十九条 用户违反本协议或任何法律、法规或侵害第三方的权利，相关的法律责任由用户全部自行承担。</p>
			<p class="bigP">第九章 协议终止及账户的暂停、注销或终止</p>
			<p>第四十条 唐鼎耀华有权终止本协议，用户有权申请唐鼎耀华终止本协议。在用户违反本协议、相关规则的情况下，或在相关法律法规、政府部门的要求下，唐鼎耀华有权通过站内信、电子邮件通知等方式终止本协议、关闭用户账户或者限制用户使用注册平台。但用户依据本协议或在唐鼎耀华产生其他协议、规则下的还未履行完毕的义务仍然有效。</p>
			...
			<p>第四十二条 用户不再使用账户时，应首先清偿所有应付款项（包括但不限于投资本金、利息、罚息、违约金、服务费、管理费等），再将账户中的可用款项（如有）全部提现或者向注册平台发出其它合法的支付指令，并向注册平台申请注销该账户，经注册平台审核同意后可正式注销用户账户。</p>
			...
			<p>第四十四条 唐鼎耀华终止提供用户账户服务时，可以立即暂停、关闭或删除用户账户及该用户账户中的所有相关资料及档案，并将用户滞留在这些账户的全部合法资金退回到用户的银行账户。用户账户的暂停、中断或终止不代表用户责任的终止，用户仍应对在使用注册平台服务期间的行为承担可能的违约或损害赔偿责任，同时唐鼎耀华可继续保留用户的相关信息。</p>
			<p class="bigP">第十章 通知</p>
			<p>第四十五条 本协议项下的通知如以公示方式作出，一经在注册平台即视为已经送达。除此之外，其他向用户个人发布的具有专属性的通知将由唐鼎耀华以下列方式中的一种或几种向用户发送：（1）用户在注册时或注册后变更用户信息时向注册平台提供的手机号码；（2）用户个人账户中的消息系统；（3）用户在注册后在注册平台绑定的电子邮箱。通知一经发送即视为送达，请用户密切关注手机短信、系统消息、电子邮件。</p>
			...
			<p>第四十七条 本协议及注册平台有关页面的相关名词可互相引用参照，如有不同理解，则以本协议条款为准。若本协议的部分条款被认定为无效或者无法执行时，本协议中的其他条款的有效性及可执行性不受影响。</p>
...
export default {
    ...
    methods:{
        ...
        getData:function(){
            ...
            .then(function(res) {//成功之后
               console.log(res.data)
                ...
                if(retCode=='0'){
                  //  alert(res.data.userInfo.id )
                   // that.param.userId = res.data.userInfo.id 
                ...
                window.location.href='https://open.weixin.qq.com/connect/oauth2/authorize?appid='+that.APPID+'&redirect_uri='+serbackUrl+'&response_type=code&scope=snsapi_userinfo&state=severAppoint_'+that.ghT+','+that.param.userId+'#wechat_redirect';
                }
                // else{
                //     MessageBox(' ',retMsg);
                // }
                ...
                if(retCode == 0){
                  //  var data=Base64.decode(res.data);
                   // data=jQuery.parseJSON(data)
                    ...
                    that.param.belongPhone = data.mobile
                    if(!that.photo==false){
        ...
        isCheck:function(){
            if(this.selimgShow == false){
                this.isValid3 = false
                MessageBox(' ','请勾选阅读《大唐财富平台注册协议》');
            }else{
                this.isValid3 = true
            }
        },
        toAppoint:function(){ 
            this.param.dtNo = this.ghT
            let that = this;
            that.phoneFn();
            that.codeFn();
            that.isCheck()
            ...
            axios({
                    method:'get',
                    url:'/wxservice/wxMemberInfo/saveSubscribe',
                ...
                .then(function(res) {//成功之后
                    ...
                    if(retCode== -7){
                       ...
                       // MessageBox(' ','系统异常');
                        ...
                        var message = '该手机号已注册且关联账号已有专属财富师，可直接登录大唐财富APP为专属财富师点亮服务之星。'
                        MessageBox.confirm('', {
                            message: message,
                            title: '',
                        ...
                        that.$router.push({
                            ...
                            name: 'appoSuccess',
                            query:{
                                userName:that.busNameT,
                                userId:that.ghT,
                                mobile:that.param.belongPhone
                            }
                        })
                    }else if(retCode == 400){
                        var serbackUrl = that.Host+'/wxservice/wxMemberInfo/saveSubscribe'
                    window.location.href='https://open.weixin.qq.com/connect/oauth2/authorize?appid='+that.APPID+'&redirect_uri='+serbackUrl+'&response_type=code&scope=snsapi_userinfo&state=severAppoint_'+that.ghT+','+that.param.userId+'#wechat_redirect';
                    }
                    // Indicator.close();
                });
            ...
            axios({
                ...
                params: {
                    ...
                    // ghT:that.businessName+'（工号'+that.ghT+'）'+that.mobile,
                     //  ghT:that.ghT+','+that.busNameT,
                       ghT:that.ghT+','+that.busNameT+','+that.param.belongPhone+',2,2',
                    }
                }
            })
            .then(function(res) {
        ...
        wxshare:function(type) {
            ...
            if (/(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)) {
                ...
                this.shareLink = this.Host+'weixin-h5/static/html/redirect.html?app3Redirect=' + encodeURIComponent(location.href.split('?')[0]+'?userId='+this.ghT+'&tgUserId='+this.param.userId)
                
            } else if (/(Android)/i.test(navigator.userAgent)) {
                //android
                this.shareLink = location.href.split('?')[0]+'?userId='+this.ghT+'&tgUserId='+this.param.userId
    ...
    created(){                   
       // Indicator.open();
        if(!this.$route.query.actId==false){ //重定向后
            ...
            this.param.userId = wxstr.split(",")[1];
        }else{
            this.ghT=this.$route.query.userId
            this.param.userId = this.$route.query.tgUserId 
        }
        this.getPhoto()
...
.inpTel::-webkit-input-placeholder {
    color: #999999;
    font-size: .373333rem;
}
.read_term{
